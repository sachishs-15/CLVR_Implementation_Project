...
class SpritesEnv(gym.Env):
    ...
    def reset(self):
        ...
        return (im / 255, {})     # normalize the image to [0, 1]   # changed this
    ...
    def step(self, action):
        ...
        return im / 255, reward, done, done, info # changed this
...
class SpritesStateEnv(SpritesEnv):
    ...
    def step(self, action):
        _, reward, done, done, info = super().step(action)
        return self._state[:, :self._n_dim].copy().flatten(), reward, done, done, info
